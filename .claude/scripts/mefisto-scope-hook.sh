...

{
    ...
    echo "Rutas permitidas: commands/, skills/, agents/, scripts/, hooks/, docs/, .claude-plugin/, .claude/{commands,skills,agents,scripts}/, .claude/settings.json, .mcp.json, src/internal/, .opencode/{agents,commands,plugins,skills}/, AGENTS.md, opencode.json, changelog.d/, README.md, CHANGELOG.md, CLAUDE.md, .gitignore."
