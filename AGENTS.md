...
| `/batch-stop` | Escribe la senal de parada suave (`pipeline-state/batch-stop`, MEF-ADR-0017) que detiene `/parallel`/`batch-pipeline.sh` sin matar ningun proceso: el eslabon o los worktrees en vuelo terminan, y la cola deja de lanzar issues nuevos |
