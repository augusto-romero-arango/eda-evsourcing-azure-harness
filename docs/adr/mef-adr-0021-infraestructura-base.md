...
| `function-app` | `azurerm_linux_function_app` (.NET 10 isolated, SystemAssigned identity, `storage_uses_managed_identity = true`) | `name`, `resource_group_name`, `location`, `service_plan_id`, `storage_account_name`, `app_insights_connection_string`, `app_settings`, `tags` | `id`, `name`, `principal_id` | no |
