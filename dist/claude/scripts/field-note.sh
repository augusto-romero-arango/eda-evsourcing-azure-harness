...
#
# --field-note y --glossary son RUTAS LOCALES con el contenido YA REDACTADO --
# tipicamente bajo .mefisto/pipeline/ (gitignorado en el consumidor, MEF-ADR-
# 0050), aunque tambien acepta una ruta fuera del repo (p. ej. un archivo
# temporal): el script solo exige que el archivo exista, nunca valida su
# ubicacion. El delta del glosario debe
