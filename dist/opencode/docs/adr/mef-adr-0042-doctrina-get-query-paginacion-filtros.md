...
- Issue #587 (este ADR); issue #608 (consecuencias del verbo QUERY en el gateway APIM -- CORS, operación wildcard del verbo y gate empírico end-to-end; cerró el punto de CORS de la sección 6); issue #583 (receta del planner que captura paginación/filtros/cadencia en el handoff -- relacionado, no bloqueante).
