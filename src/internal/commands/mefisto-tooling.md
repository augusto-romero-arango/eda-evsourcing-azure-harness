---
{
  ...
  "profile": "fast",
  "arguments": "<numero-de-issue> [--models 'agente=modelo[,agente=modelo...]'] [--variant <label>]"
}
---
...
```
/mefisto-tooling 42 --variant a --models writer=<modelo-a>
...
```bash
{{mefisto:run mefisto-tmux-pipeline.sh --tooling $ARGUMENTS}}
```
