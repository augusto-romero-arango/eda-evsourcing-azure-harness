...
published_claude_mcp_tools() { case "$1" in microsoft-learn) printf 'mcp__microsoft-learn__*' ;; terraform) printf 'mcp__terraform__*, mcp__plugin_terraform_terraform__*' ;; *) return 1 ;; esac; }
