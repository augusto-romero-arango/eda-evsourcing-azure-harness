...
- [ ] **Movimiento o renombrado de eventos persistidos (MEF-ADR-0036)**: si el issue mueve, renombra o extrae a otra biblioteca un tipo de evento persistido y el entorno destino ya tiene streams escritos, `## Dependencias` declara la secuencia de dos despliegues (ver "Identidad de eventos persistidos" abajo) y ninguna purga del entorno aparece como criterio de aceptacion separado del issue que mueve los tipos.
