...
- [ ] CA-4: **Extension de la suite de smoke e2e** (MEF-ADR-0048 seccion 6, obligatorio siempre que este issue agregue/modifique una tool): pin del catalogo `tools/list`, pin del `required` del `inputSchema` de la tool, y una tool call real de la tool contra el entorno dev. Las tres piezas, ninguna opcional.
